...
@section('title', 'Add Borrowing Transaction')
...
<div class="container">
    <div class="form-card">
        <div class="card-header">
            <h2>Add New Borrowing Transaction</h2>
        </div>
        ...
        <form action="{{ route('borrowing_transactions.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="date" name="borrow_date" class="form-input" value="{{ old('borrow_date') }}" required>
            </div>
